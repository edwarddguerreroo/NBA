...
class HybridPTSPredictor(BaseDLModel):
    """
    ...
    def __init__(self, config):
        ...
        """
        super(HybridPTSPredictor, self).__init__(config, "HybridPTSPredictor")
...
class MultiScaleHybrid(HybridPTSPredictor):
    """
...
class AdaptiveHybrid(HybridPTSPredictor):
    """
