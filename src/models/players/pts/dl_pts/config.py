"""
Configuración para Modelos de Deep Learning PTS
==============================================

Contiene todas las configuraciones y hiperparámetros para los diferentes
modelos de Deep Learning especializados en predicción de puntos.
"""
...
class BaseConfig:
    ...
    input_features: int = 26  # Número real de features numéricas generadas
    target_feature: str = "PTS"
